const places = [
  ...
  { name: "Orthodox Church", url: "./orthodox-church.html" },
  { name: "Supara Chunkurchak", url: "./supara-chunkurchak.html" },
  { name: "Balykchy", url: "./balykchy.html" },
  { name: "Semenovskoe Gorge", url: "./Semenov-gorge.html" },
  { name: "Aska Thermal Spa", url: "./aska-thermal-spa.html" },
];
